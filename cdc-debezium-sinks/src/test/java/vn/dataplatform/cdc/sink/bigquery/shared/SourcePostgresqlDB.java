...
import static vn.dataplatform.cdc.sink.bigquery.TestConfigSource.*;
...
import vn.dataplatform.cdc.sink.bigquery.BaseBigqueryTest;

/**
 * @author tuan.nguyen3
 */
public class SourcePostgresqlDB implements QuarkusTestResourceLifecycleManager {
  public static final String POSTGRES_USER = "postgresql";
  public static final String POSTGRES_PASSWORD = "postgresql";
