...
public class TestConfigSource implements ConfigSource {
  public static String BQ_LOCATION = "US";
  // overriden by user src/test/resources/application.properties
  public static String BQ_PROJECT = "data-engineering-230006";
  public static String BQ_DATASET = "tuan_test";
  ...
  public TestConfigSource() {
    ...
    config.put("debezium.source.offset.storage", "vn.dataplatform.cdc.sinks.bigquery.offset.BigqueryOffsetBackingStore");
    ...
    config.put("debezium.source.schema.history.internal", "vn.dataplatform.cdc.sinks.bigquery.history.BigquerySchemaHistory");
